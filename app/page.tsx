  ...
  const projects = [
    {
      ...
      description: 'A comprehensive food delivery platform with dynamic restaurant listings, filtering options, and order management features.',
    ...
    },
    {
      ...
      description: 'Location-based healthcare platform for discovering hospitals and scheduling appointments with intelligent filtering.',
      technologies: ['MongoDB', 'Express.js', 'React.js', 'Node.js'],
      links: [
        { label: 'Live Demo', url: 'https://my-hospital-management.netlify.app/' },
        { label: 'GitHub', url: 'https://github.com/Karthikeyadevarakonda/HospitalManagementAPP' }
      ],
      date: 'May 2024',
      featured: true
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
              ...
              {['home', 'about', 'education', 'experience', 'projects', 'skills', 'contact'].map((section) => (
                <button
                  ...
                  className={`capitalize transition-all duration-200 hover:text-blue-600 ${
                    activeSection === section ? 'text-blue-600 font-semibold' : 'text-slate-600'
                  }`}
                >
                  {section}
                </button>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              A passionate developer and trainer with expertise in full-stack development and a commitment to continuous learning.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-slate-700 leading-relaxed">
                I'm a dedicated software developer currently pursuing my B.Tech in Computer Science Engineering. 
                With hands-on experience in Java development and full-stack web technologies, I enjoy creating 
                innovative solutions that make a real impact.
              </p>
              
              <p className="text-lg text-slate-700 leading-relaxed">
                My journey in technology has been driven by curiosity and a desire to solve complex problems. 
                I've worked on various projects ranging from food delivery platforms to healthcare management systems, 
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Badge className="bg-orange-100 text-orange-800 hover:bg-orange-200">Innovative</Badge>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-700">Nellore, Andhra Pradesh</span>
                </div>
                <div className="flex items-center gap-3">
                  <GraduationCap className="text-purple-600" size={20} />
                  <span className="text-slate-700">B.Tech CSE Student (2022-26)</span>
                </div>
                <div className="flex items-center gap-3">
                  <Briefcase className="text-green-600" size={20} />
                  <span className="text-slate-700">Java Developer Intern Experience</span>
                </div>
                <div className="flex items-center gap-3">
      ...
      <section id="education" className="py-20 px-4 bg-white/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">Education</h2>
            <p className="text-xl text-slate-600">My academic journey and qualifications</p>
          </div>
            ...
            <div className="space-y-8">
              <Card className="border-l-4 border-l-blue-500 hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="text-xl text-slate-800">B.Tech. Computer Science Engineering</CardTitle>
              ...
              <Card className="border-l-4 border-l-purple-500 hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="text-xl text-slate-800">Intermediate (12th Grade)</CardTitle>
              ...
              <Card className="border-l-4 border-l-green-500 hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="text-xl text-slate-800">SSC (10th Grade)</CardTitle>
      ...
      <section id="experience" className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">Experience</h2>
            <p className="text-xl text-slate-600">Professional internships and achievements</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <Card className="hover:shadow-xl transition-all duration-300 overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50">
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="text-2xl text-slate-800">Java Developer Intern</CardTitle>
                    <CardDescription className="text-lg text-blue-600 font-semibold">
                      COINCENT.AI
                    </CardDescription>
                    <p className="text-slate-600 mt-2">Apr 2024 – Jun 2024 | Remote</p>
                  </div>
              ...
              <CardContent className="pt-6">
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Worked on an Employee Management System web application using the Spring Framework to streamline employee data management.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Built and optimized over 10 RESTful APIs for features like employee creation, updates, and reporting.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Improved the system's performance by 25% through code optimization and debugging.</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 mt-2">Mar 2024 – Apr 2024 | Remote</p>
                  </div>
              ...
              <CardContent className="pt-6">
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Implemented an ATM Interface system using Java, enabling secure and efficient transactions for banking customers.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Constructed and tested core features, including balance inquiry, withdrawal, deposit, and fund transfer, reducing transaction time by 30%.</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section id="projects" className="py-20 px-4 bg-white/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600">Showcasing my technical skills and creativity</p>
          </div>
      ...
      <section id="skills" className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">Skills</h2>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-4 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
   ...
   github.com/Karthikeyadevarakonda
                  ...
                  <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs sm:text-normal">Connect with me on LinkedIn</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('mailto:karthikeya8787@gmail.com', '_blank')}
                  >
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6 mb-8">
            <Button 
              ...
              onClick={() => window.open('https://github.com/Karthikeyadevarakonda', '_blank')}
            >
              <Github size={20} />
            </Button>
            <Button 
            ...
            <Button 
              ...
              size="sm" 
              className="text-slate-300 hover:text-white"
              onClick={() => window.open('https://www.linkedin.com/in/devarakondakarthikeya578', '_blank')}
            >
